    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div class="max-w-md w-full text-center">
            ...
            <div class="mb-8">
                ...
                <h2 class="text-2xl font-semibold text-foreground mb-4">Erreur serveur</h2>
                <p class="text-muted-foreground mb-6">
                    Une erreur interne s'est produite. Notre équipe a été notifiée et nous travaillons à la résoudre.
                </p>
            </div>
            ...
            <!-- Illustration -->
            <div class="mt-12 text-6xl opacity-20 animate-pulse">
                ⚠️
            </div>
        </div>
    </div>
