...
<template>
    <ActionSection>
        ...
        <template #description>
            Ajoutez une sécurité supplémentaire à votre compte avec l'authentification à deux facteurs.
        </template>
        ...
        <template #content>
            ...
            <div class="mt-3 max-w-xl text-sm text-slate-400">
                <p>
                    Lorsque l'authentification à deux facteurs est activée, vous serez invité à fournir un jeton sécurisé et aléatoire lors de l'authentification. Vous pouvez récupérer ce jeton depuis l'application Google Authenticator sur votre téléphone.
                </p>
            </div>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-slate-400">
                        <p v-if="confirming" class="font-semibold">
                            Pour terminer l'activation de l'authentification à deux facteurs, scannez le code QR suivant avec votre application authenticateur ou entrez la clé d'installation et fournissez le code OTP généré.
                        </p>

                        <p v-else>
                            L'authentification à deux facteurs est maintenant activée. Scannez le code QR suivant avec votre application authenticateur ou entrez la clé d'installation.
                        </p>
                    </div>

                    <div class="mt-4 p-2 inline-block bg-white" v-html="qrCode" />

                    <div v-if="setupKey" class="mt-4 max-w-xl text-sm text-slate-400">
                        <p class="font-semibold">
                            Clé d'installation: <span v-html="setupKey"></span>
                        </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    ...
                    <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-slate-700 text-slate-100 rounded-lg border border-slate-600">
