...
const classes = computed(() => {
    return props.active
        ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary text-start text-base font-medium text-primary bg-secondary focus:outline-none focus:text-primary focus:bg-card focus:border-primary transition duration-150 ease-in-out'
